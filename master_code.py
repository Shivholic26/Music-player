...
statusbar = ttk.Label(root, text="Let's Make some Noise",  font='Arial 8 italic')
statusbar.pack(side=BOTTOM, fill=X)
statusbar1 = ttk.Label(root, text="Welcome to Music Player World",  font='Arial 8 italic')
...
play_img=PhotoImage(file='/home/shivam/Desktop/coding/python/play.png')
playBtn = ttk.Button(middleframe, image=play_img, command=play_music)
playBtn.grid(row=0, column=0, padx=10)
stop_img=PhotoImage(file='/home/shivam/Desktop/coding/python/stop.png')
stopBtn = ttk.Button(middleframe, image=stop_img, command=stop_music)
stopBtn.grid(row=0, column=1, padx=10)
pause_img=PhotoImage(file='/home/shivam/Desktop/coding/python/pause.png')
pauseBtn = ttk.Button(middleframe, image=pause_img, command=pause_music)
